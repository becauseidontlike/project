...
warsTime.innerHTML =  moment().tz("Europe/Warsaw").format("hh:mm A");
...
manchTime.innerHTML =  moment().tz("Europe/London").format("hh:mm A");
...
melbTime.innerHTML =  moment().tz("Australia/Melbourne").format("hh:mm A");