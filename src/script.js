setInterval(function () {
  ...
  melbDate.innerHTML = moment()
    .tz("Australia/Melbourne")
    .format("MMMM Do YYYY");
  melbTime.innerHTML = moment()
    .tz("Australia/Melbourne")
    .format("hh:mm:ss [<small>]A[</small>]");
...
function update(event) {
  ...
  cityElement.innerHTML = `<div class="cities">
                ...
                <div class="time">${cityT.format(
                  "h:mm:ss"
                )} <small>${cityT.format("A")}</div>
            </div>
            <br />
